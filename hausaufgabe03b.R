...
# 2014-04-25
# Diese Datei dient Prüfungszwecken.
...
# Es kann mehrere Elemente mit der gleichen Anzahl geben, in diesem Fall werden mehrere Werte angezeigt.In dem vorliegenden Fall ist der Code korrekt, da es nur zwei (m/w) Werte gibt. 
